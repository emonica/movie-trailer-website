...
fight_club = media.Movie("Fight Club", 
	("An insomniac office worker looking for a way to change his life crosses paths "
		"with a devil-may-care soap maker."), 
...
memento = media.Movie("Memento", 
	("A man creates a strange system to help him remember things; so he can hunt for "
		"the murderer of his wife without his short-term memory loss being an obstacle."), 
...
the_apartment = media.Movie("The Apartment", 
	("A man tries to rise in his company by letting its executives use his apartment "
		"for trysts, but complications and a romance of his own ensue."), 
